 ...
 */
app.get("/items/:item", homeController.sendReqParam); // @TODO: "/items/:vegetable"로의 GET 요청 처리 (p. 153)
app.get("/user/:userID", homeController.sendUserReqParam); // @TODO: "/users/:userID"로의 GET 요청 처리 (추가)
app.get("/courses/:coursesID", homeController.sendCoursesParam); // @TODO: "/courses/:courseID"로의 GET 요청 처리 (추가)
